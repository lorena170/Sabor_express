...
label_nome = tk.Label(janela, text="Digite seu nome:", bg="light blue")
label_nome.pack(pady=5)
caixa_texto = tk.Entry(janela, width=40)
caixa_texto.pack(pady=5)

# Criar botões de rádio
label_preferencia = tk.Label(janela, text=" Escolha sua preferência:", bg="light blue")
label_preferencia.pack(pady=10)

var_radio = tk.StringVar(value="Café")
radio_cafe = tk.Radiobutton(janela, text="Café", variable=var_radio, value="Café", bg="brown", fg= "white")
radio_cha = tk.Radiobutton(janela, text="Chá", variable=var_radio, value="Chá", bg="green", fg="black" )
radio_suco = tk.Radiobutton(janela, text="Suco", variable=var_radio, value="Suco", bg="yellow", fg="red")
radio_agua = tk.Radiobutton(janela, text="Água", variable=var_radio, value="Água", bg="blue", fg="white")
...
check_saudacao =tk.Checkbutton(janela, text="Usar saudação informal", variable=var_check_saudacao, bg="light blue", fg="magenta")
check_saudacao.pack(pady=5)

var_check_personalizada = tk.BooleanVar()
check_personalizada =tk.Checkbutton(janela, text="Usar saudação personalizada", variable=var_check_personalizada, bg="light blue", fg="blue")
